...
function NewsCard({ title, description, url, urlToImage}) {
    return(
        <>
            ...
            <a href={url}><img src={urlToImage?urlToImage:"https://intellij-support.jetbrains.com/hc/user_images/QZP8LIk0pW3bOuWt1P7HIQ.png"} style={{height:"300px", width:"100%"}} class="card-img-top" alt="NewsImage" /></a>
                <div class="card-body">
